...
def extract(url, max_tries, dir):
    """
    This will call an api. If there's a server side issue it will try retry for the specfified number of times.
    The data will be saved in teh specified directory.
